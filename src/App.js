...
import './App.css';
// This is the file that's use to connect to Solana through RPC bridge
...
const App = () => {
  ...
  const createGifAccount = async() => {
    try {
      ...
      console.log("error creating base account account", error);
    }
  }
  ...
  const sendGif = async () => {
    ...
    //https://media2.giphy.com/media/NVBR6cLvUjV9C/giphy.gif?cid=790b761181d0050f52fedf46a1189988b68757ccc04e367c&rid=giphy.gif&ct=g
    setInputValue('');
